...
1. What is the DOM?
DOM stands for Document Object Model. It's a go-between for Javascript and HTML. Modifying the DOM adds html elements using javascript, but does not modify the original html files, it's only through the browser.

2. What is an event?
An event is something that can be reacted to by scripts. Some examples are clicks, scrolling, amd page load.

3. What is an event listener?
An event listener is a piece of code that waits for an event from the browser. Once it "hears" the event go off, it runs whatever code it holds.

4. Why would we convert a NodeList into an Array?
Because NodeLists don't get to use all of the advanced array methods in javascript, you can do more detailed operations if you convert to an array.

5. What is a component?
A component is a reusable piece of code that builds html elements. An example is building pinterest-like image cards from a set of data, looping over each item in the data to create a new element on the page.
